...
public class PositionController{
	...
	public void changePriority(int id, int priority){
		db.executeUpdate("Change Position with id " + id + " to Priority " + priority, "update Position set priority = " + priority +
				" where position_id = " + id);
	}

	
	public void changePositionTitle(int id, String newTitle) {
		db.executeUpdate("Change Position with id " + id + " to Title " + newTitle, "update Position set title = '" + newTitle +
				"' where position_id = " + id);
	}
	
	
	public void changePositionDescription(int id, String newDesc) {
		db.executeUpdate("Change Position with id " + id + " to Description " + newDesc, "update Position set description = '" + newDesc +
				"' where position_id = " + id);	
	}
